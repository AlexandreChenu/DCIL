...
class SAC(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            # wrong_reward = (abs(replay_data.rewards)> 1.).int()
            # if wrong_reward.sum() > 0.:
            ...
            # dones = replay_data.dones[:] + missing_dones[:]
            # print("dones[:10] = ", dones[:10])
            # print("1-dones[:10] = ", (1-dones)[:10])

            # for i in range(replay_data.observations["observation"].shape[0]):
            #     print("\nobs desired_goal = ", replay_data.observations["desired_goal"][i])
            ...
            #     print("next obs achieved_goal_goal = ", replay_data.next_observations["achieved_goal"][i])
            ...
            with th.no_grad():
                ...
                target_q_values = replay_data.rewards + (1 - dones) * self.gamma * next_q_values
