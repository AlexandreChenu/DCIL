...
if __name__ == '__main__':
    ...
    cur_path = os.getcwd()
    dir_path = cur_path + "/xp/GCPI_" + args["env_name"] + "_" + args["RL_algo"] + "_" + str(args["bonus_reward_bool"]) + "_" + str(args["do_overshoot"]) + "_" + str(args["gamma"]) + "_" + str(args["alpha"]) + "_" + dt_string
    ...
    args["demo_length"] = len(env.skill_manager.L_states)
