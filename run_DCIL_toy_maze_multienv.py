...
if __name__ == '__main__':
	...
	cur_path = os.getcwd()
	dir_path = cur_path + "/xp/DCIL_" + args["env_name"] + "_" + args["RL_algo"] + "_" + str(args["bonus_reward_bool"]) + "_" + str(args["do_overshoot"]) + "_" + str(args["add_ent_reg"]) + "_" + str(args["n_envs"]) + "_" + dt_string
