...
class SimpleMazeEnv(Maze, gym.Env):
    ...
    def setup(self,args):
        super(SimpleMazeEnv,self).__init__(args['mazesize'],args['mazesize'],seed=args['random_seed'],standard=args['mazestandard'])
    ...
    def update_state(self, state, a, DT):
        ...
        state[0] = state[0] + a[0]*DT
        state[1] = state[1] + a[1]*DT
